  ...
  LangString dirAdminDesc ${LANG_ENGLISH} "Please specify the directory where pgAdmin III will be insalled."
  LangString dirAdminDesc ${LANG_RUSSIAN} "Пожалуйста, задайте папку для установки утилиты pgAdmin III."
  ...
  ;LangString DATADIR_EXIST_TEXT2 ${LANG_ENGLISH} "This directory and its configuration will be used for this installation. "
  ;LangString DATADIR_EXIST_TEXT2 ${LANG_RUSSIAN} "Эта папка и ее конфигурация будет использована для этой установки сервера."
  ...
  LangString DATADIR_EXIST_ERROR1 ${LANG_RUSSIAN} "Уже имеется файл с именем $DATA_DIR . Невозможно создать папку с таким именем."
