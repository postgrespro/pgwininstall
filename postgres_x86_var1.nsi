...
OutFile "${PRODUCT_NAME}_${PRODUCT_VERSION}_${PG_INS_SUFFIX}"
...
Section "Microsoft Visual C++ 2013 Redistibutable" secMS
	...
	ExecWait "$1  /passive /norestart" $0
        DetailPrint "vcredist_x86.exe return $0"
        Delete $1
...
*/
	...
	${NSD_CreatePassword} 62u 72u 100u 12u ""
	Pop $Pass1

	${NSD_CreateLabel} 0 90u 60u 12u "$(DLG_PASS2)"
	Pop $Label2

	${NSD_CreatePassword} 62u 88u 100u 12u ""
	Pop $Pass2
