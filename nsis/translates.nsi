...
LangString PostgreSQLString ${LANG_RUSSIAN} "Сервер PostgreSQL"
  ...
  LangString DESC_Sec1die ${LANG_RUSSIAN} "Пожалуйста, задайте каталог, куда будет установлен PostgreSQL"
  ...
  LangString SERVER_EXIST_TEXT1 ${LANG_RUSSIAN} "Найдена инсталляция сервера PostgresSQL в каталоге "
  ...
  LangString SERVER_EXIST_TEXT2 ${LANG_RUSSIAN} "Эта установка будет обновлена.$\n$\nДля завершения обновления может потребоваться перезапустить PostgreSQL сервер"
