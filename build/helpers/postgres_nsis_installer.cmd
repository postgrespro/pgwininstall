...
SET PRODUCT_DIR_REGKEY95=SOFTWARE\%COMPANY_NAME%\%ARCH%\%PRODUCT_NAME%\9.5
SET OLD_PRODUCT_DIR_REGKEY=SOFTWARE\%COMPANY_NAME%\%ARCH%\9.5
...
IF %ONE_C% == YES (
  ...
  SET PG_DEF_SERVICEID="postgrespro-%ARCH%-%PG_MAJOR_VERSION%"
  ...
  SET PG95_REG_KEY="%PRODUCT_DIR_REGKEY95%\Installations\postgresql-9.5"
  SET PG95_REG_SERVICE_KEY="%PRODUCT_DIR_REGKEY95%\Services\postgresql-9.5"
...
>>%NSIS_RES_DIR%\postgres.def.nsh ECHO !define PG95_REG_KEY %PG95_REG_KEY%
>>%NSIS_RES_DIR%\postgres.def.nsh ECHO !define PG95_REG_SERVICE_KEY %PG95_REG_SERVICE_KEY%
