...
IF %ONE_C% == YES (
  ...
  SET PG_DEF_SERVICEID="postgresql-%ARCH%-%PG_DEF_VERSION_SHORT%"
  SET PG_INS_SUFFIX="%ARCH%bit_Setup.exe"
  SET PG_REG_KEY="SOFTWARE\%COMPANY_NAME%\%ARCH%\%PRODUCT_NAME%\%PG_DEF_VERSION_SHORT%\Installations\postgresql-%PG_DEF_VERSION_SHORT%"
  SET PG_REG_SERVICE_KEY="SOFTWARE\%COMPANY_NAME%\%ARCH%\%PRODUCT_NAME%\%PG_DEF_VERSION_SHORT%\Services\postgresql-%PG_DEF_VERSION_SHORT%"
  SET PRODUCT_DIR_REGKEY="SOFTWARE\%COMPANY_NAME%\%ARCH%\%PRODUCT_NAME%\%PG_DEF_VERSION_SHORT%"
  SET PRODUCT_VERSION="%PG_DEF_VERSION_SHORT% (%ARCH%)"
)

SET PG_DEF_PORT="%DEFAULT_PORT%"
SET PG_DEF_SUPERUSER="%DEFAULT_USER%"
SET PG_DEF_SERVICEACCOUNT="NT AUTHORITY\NetworkService"
SET PG_DEF_BRANDING="%PRODUCT_NAME% %PG_DEF_VERSION_SHORT% (%ARCH%)"
