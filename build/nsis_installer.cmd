...
REM 5. Visual Studio 2010 Redistibutable (x86, x64) [Place it to nsis directory]
REM 6. PostgreSQL and PgAdmin3 binaries
...
REM You need to uncomment this line: ;!define PG_64bit in postgresql.nsi
...
IF NOT EXIST vcredist_x64.exe GOTO :ERROR
IF NOT EXIST vcredist_x86.exe GOTO :ERROR
