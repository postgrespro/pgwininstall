...
SET PG_INS_SOURCE_DIR="C:\pg\distr_%POSTGRES_ARCHITECTURE%_%PG_FULL_VER%\postgresql\*.*"
...
SET ADMIN_INS_SOURCE_DIR="C:\pg\distr_%POSTGRES_ARCHITECTURE%_%PG_FULL_VER%\pgadmin\*.*"
